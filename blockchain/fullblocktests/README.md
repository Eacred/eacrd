...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://godoc.org/github.com/Eacred/eacrd/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/Eacred/eacrd/blockchain/fullblocktests
```
