...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://godoc.org/github.com/Eacred/eacrd/blockchain/chaingen)
...
* [Basic Usage Example]
  (https://godoc.org/github.com/Eacred/eacrd/blockchain/chaingen#example-package--BasicUsage)
...
```bash
$ go get -u github.com/Eacred/eacrd/blockchain/chaingen
```
