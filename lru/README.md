...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://godoc.org/github.com/Eacred/eacrd/lru)
...
```bash
$ go get -u github.com/Eacred/eacrd/lru
```

## Examples

* [Basic Usage](https://godoc.org/github.com/Eacred/eacrd/lru#example-package--BasicUsage)
