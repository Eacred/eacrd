...
import (
	...
	"github.com/Eacred/eacrd/connmgr"
	"github.com/Eacred/eacrd/database"
	_ "github.com/Eacred/eacrd/database/ffldb"
	"github.com/Eacred/eacrd/dcrutil"
	"github.com/Eacred/eacrd/internal/version"
	"github.com/Eacred/eacrd/mempool"
	"github.com/Eacred/eacrd/rpc/jsonrpc/types"
	"github.com/Eacred/eacrd/sampleconfig"
	"github.com/Eacred/go-socks/socks"
...
type config struct {
	...
	AltDNSNames          []string      `long:"altdnsnames" description:"Specify additional dns names to use when generating the rpc server certificate" env:"ECRD_ALT_DNSNAMES" env-delim:","`
