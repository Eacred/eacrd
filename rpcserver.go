...
// list of commands that we recognize, but for which eacrd has no support because
...
func jsonAuthFail(w http.ResponseWriter) {
	w.Header().Add("WWW-Authenticate", `Basic realm="eacrd RPC"`)
