...
Although it was primarily written for eacrd, this package has intentionally been
...
second layer alternatives, etc). Also, the current fill rate of blocks in eacred
...
out earlier should be sufficient for current fill rate of eacred's network.
