...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://godoc.org/github.com/Eacred/eacrd/peer)
...
```bash
$ go get -u github.com/Eacred/eacrd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/Eacred/eacrd/peer#example-package--NewOutboundPeer)  
