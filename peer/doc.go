...
A quick overview of the major features peer provides are as follows:
 ...
 - Provides a basic concurrent safe Decred peer for handling eacred
...
caller to specify things such as the user agent name and version, the eacred
network to use, which services it supports, and callbacks to invoke when eacred
...
In order to do anything useful with a peer, it is necessary to react to eacred
...
For convenience, a callback hook for all of the currently supported eacred
...
(https://godoc.org/github.com/Eacred/eacrd/wire#hdr-Bitcoin_Improvement_Proposals)
*/
package peer
