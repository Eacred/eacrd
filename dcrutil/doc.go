...
A Block defines a Eacred block that provides easier and more efficient
...
A Tx defines a Eacred transaction that provides more efficient manipulation of
...
The Address interface provides an abstraction for a Eacred address.  While the
most common type is a pay-to-pubkey-hash, Eacred already supports others and
