...
// Copyright (c) 2015 The Eacred developers
...
// See GoDoc for example: https://godoc.org/github.com/Eacred/eacrd/dcrutil#example-Amount
...
// useful for services that build on top of Eacred (for example, calculating
