...
//
// In addition to the main Eacred network, which is intended for the transfer
...
// wire.EacredNet using ParamsForNet, but be aware that this usage is
...
//  }
//
// If an application does not use one of the standard Eacred networks, a new
