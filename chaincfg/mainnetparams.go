...
func MainNetParams() *Params {
	...
	return &Params{
		...
		PubKeyAddrID:         [2]byte{0x14, 0x85}, // starts with Dk
		PubKeyHashAddrID:     [2]byte{0x08, 0x3e}, // starts with Ds
		PKHEdwardsAddrID:     [2]byte{0x08, 0x1e}, // starts with De
		PKHSchnorrAddrID:     [2]byte{0x08, 0x02}, // starts with DS
		ScriptHashAddrID:     [2]byte{0x08, 0x1b}, // starts with Dc
		PrivateKeyID:         [2]byte{0x23, 0xdd}, // starts with Pm
		...
		HDPrivateKeyID: [4]byte{0x03, 0xfe, 0xa5, 0xe9}, // starts with dprv
		HDPublicKeyID:  [4]byte{0x03, 0xfe, 0xa8, 0x27}, // starts with dpub
